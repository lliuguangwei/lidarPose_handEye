...
public:
  ...
  virtual void onInit() {
    ...
    points_sub = nh.subscribe("/lidar_left/points", 10032, &PrefilteringNodelet::cloud_callback, this); //  /lidar_left/points  velodyne_points
    points_pub = nh.advertise<sensor_msgs::PointCloud2>("/filtered_points", 10032);
  }
